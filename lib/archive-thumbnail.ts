...
import { canPlayArchiveVideo, getArchiveAccess, getArchiveVideo } from "./archive";
...
export async function serveArchiveThumbnail(id: string, cookieHeader: string | null) {
  ...
  const source = video.thumbnailUrl || `https://i.ytimg.com/vi/${video.youtubeId}/hqdefault.jpg`;
  try {
